...
<hr />
<button class="accordion">${ContractConfigurationLogo()}Contract Configuration</button>
<div class="panel">
...
<button id="erc20configurationButton" class="accordion">${Erc20Logo()} Wallet Configuration</button>
<div class="panel">
    <table id="erc20-table">
        ...
        <tr>
            ...
            <td><input aria-label="erc20 decimal input" placeholder="18" id="erc20-decimals" type="number" /></td>
